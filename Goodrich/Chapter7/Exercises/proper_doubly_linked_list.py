...
class DoublyLinkedList(SinglyLinkedList):
    ...
    def __init__(self, head_element):
        ...
        self._header: DoublyLinkedList._Node = self._Node(head_element, None)
    ...
    def insert_after(self, e, guide: DoublyLinkedList._Node):
        ...
        if self.is_empty():
            ...
            newest = self._Node(e, self._tail.next)
            newest.prev = self._tail
            self._tail.next = self._tail = newest
        else:
            newest = self._Node(e, guide.next)
            newest.prev = guide
            guide.next = newest
        self._size += 1
        return newest
